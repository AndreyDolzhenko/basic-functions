...
// dayOfWeek - из массива week указываем индекс первого дня недели в году, например 2, если первое января в этом году - среда.
// year - указываем нужный год, например 2025
